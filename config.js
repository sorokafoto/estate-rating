...
window.APP_CONFIG = {
  ...
  nominations: [
    ...
    },
    {
      ...
      desc: "Проработали наибольшее кол-во заявок за\u00A0неделю исследования, включая выходные",
    ...
    },
    {
      ...
      desc: "Используют максимум каналов связи для\u00A0поиска клиента, который не\u00A0берет трубку",
    ...
    },
    {
      ...
      desc: "Максимально внедрили в\u00A0работу отечественный мессенджер MAX",
      type: "max_channel_share",
      nominees: ["Каскад", "Арбан", "СК Атлант"],
      nomineeValues: [31, 30, 29],
    },
    {
      id: "bulldog_grip",
