...
function buildMarketSummary(developers, events) {
  ...
  return [
    ...
    { metric: "avg_call_response_mean", value: market.avg_call_response?.mean ?? null },
    { metric: "avg_call_response_best", value: market.avg_call_response?.best ?? null },
    ...
    { metric: "no_call_share_mean", value: market.no_call_share?.mean ?? null },
    { metric: "no_call_share_best", value: market.no_call_share?.best ?? null },
